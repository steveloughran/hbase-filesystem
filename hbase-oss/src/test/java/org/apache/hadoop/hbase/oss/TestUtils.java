...
public class TestUtils {
  ...
  public static HBaseObjectStoreSemantics getFileSystem(Configuration conf) throws Exception {
    ...
    try {
      ...
      final Class<? extends HBaseObjectStoreSemantics> aClass = conf.getClass(HBOSS_CLASSNAME,
          HBaseObjectStoreSemantics.class,
          HBaseObjectStoreSemantics.class);
      HBaseObjectStoreSemantics hboss = aClass.newInstance();
